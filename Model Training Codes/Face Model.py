...
height=128
width=128
path1='/content/drive/My Drive/face/real/'
...
for i in realfiles1:
  try:
    path1='/content/drive/My Drive/face/real/'+i
...
path2='/content/drive/My Drive/face/fake/'
realfiles2 = sorted([ f for f in listdir(path2) if isfile(join(path2,f)) ])
#print(realfiles2)

for i in realfiles2:
  try:
    path2='/content/drive/My Drive/face/fake/'+i
...
checkpoint = ModelCheckpoint(
    '/content/drive/My Drive/face_model.h5',
    monitor='accuracy',
    save_best_only=True,
    verbose=1
)
